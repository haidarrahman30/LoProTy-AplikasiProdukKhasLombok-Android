...
class MinumanAdapter(private val listData: ArrayList<Minuman>) : RecyclerView.Adapter<MinumanAdapter.ListViewHolder>() {
    ...
    override fun onBindViewHolder(holder: ListViewHolder, position: Int) {
        ...
        holder.btnDetail.setOnClickListener {
            ...
            detailIntent.putExtra(DetailActivity.EXTRA_CATEGORY, "Minuman")
