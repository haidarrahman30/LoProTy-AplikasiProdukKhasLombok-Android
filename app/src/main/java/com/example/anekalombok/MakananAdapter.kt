...
class MakananAdapter(private val listData: ArrayList<Makanan>) : RecyclerView.Adapter<MakananAdapter.ListViewHolder>() {
    ...
    override fun onBindViewHolder(holder: ListViewHolder, position: Int) {
        ...
        holder.btnDetail.setOnClickListener {
            ...
            detailIntent.putExtra(DetailActivity.EXTRA_CATEGORY, "Makanan")
